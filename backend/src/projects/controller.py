...
from projects.repository import (
    ProjectRepository, SentenceRepository, 
    FootageChoiceRepository, MusicRecommendationRepository
)
from projects.schemas import (
    ProjectCreate, ProjectUpdate, SentenceCreate, 
    FootageChoiceCreate, MusicRecommendationCreate, SelectedFootage
)
