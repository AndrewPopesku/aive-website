...
async def create_project(
    ...
    from projects.schemas import generate_id, SentenceCreate, SelectedFootage
    from base.config import get_settings
    from video_processing.services import transcribe_audio, find_footage_for_sentence
    import shutil
    import os
    ...
    try:
        ...
        for sentence_data in sentences_data:
            ...
            footage_url = await find_footage_for_sentence(
                sentence_data["text"], 
                sentence_data.get("translated_text")
            )
...
async def submit_footage_choices(
    ...
    return MusicResponse(
        ...
        recommended_music=music_recommendations
    )
