...
export type UpdateRenderStatusApiV1RenderStatusTaskIdPutResponses = {
    /**
     * Response Update Render Status Api V1 Render Status  Task Id  Put
     * Successful Response
     */
    200: {
        [key: string]: string;
...
export type UpdateRenderStatusApiV1RenderStatusTaskIdPutResponse = UpdateRenderStatusApiV1RenderStatusTaskIdPutResponses[keyof UpdateRenderStatusApiV1RenderStatusTaskIdPutResponses];
